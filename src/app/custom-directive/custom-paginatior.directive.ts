...
export class AppPaginationDirective implements DoCheck, AfterViewInit {
  ...
  constructor(
    ...
    this.matPag._intl.itemsPerPageLabel = 'Results per page    ';
  }

  ngDoCheck(): void {
    let testValue = JSON.parse(localStorage.getItem('tempPaging'));
    ...
    if (
      ...
      this.matPag.length = testValue.length;
      this.matPag.pageSize = testValue.pageSize;
      this.matPag.pageIndex = testValue.index;
      localStorage.removeItem('tempPaging');
    }
  }
